...
안녕하세요! 보안 솔루션을 직접 만들고 적용하는 보안 엔지니어 **이가영**입니다.

**"복잡한 시스템을 안전하게, 그리고 스마트하게 자동화합니다."**

코드 취약점을 찾는 공격자(Offensive)의 시선과 안전한 시스템을 짓는 방어자(Defensive)의 관점을 모두 가지고 있습니다. 단순히 문제를 짚어내는 것을 넘어, **실질적인 해결책을 자동화된 파이프라인으로 구현**하는 일에 집중하고 있습니다. 😊

- ☁️ 인프라를 코드로 안전하게 관리하는 **AWS 기반 DevSecOps 파이프라인** 설계
- 📊 대규모 서버 환경에서 **취약점 점검부터 조치, 보고서까지 자동화**하는 플랫폼 구축 (KISA 기준)
- 🚁 MAVLink 프로토콜 취약점 분석 및 펌웨어 리버싱을 통한 **드론 제어권 탈취 등 하드웨어 보안 연구**

## 📚 참여 프로그램

- **현대 오토에버 모빌리티 sw 스쿨 IT 보안 3기** (2026.04.04 ~ 진행 중)
...
**Security Tools**  
<img src="https://img.shields.io/badge/IDA_Pro-4B275F?style=flat-square&logo=hexrays&logoColor=white"/> <img src="https://img.shields.io/badge/Burp_Suite-FF6633?style=flat-square&logo=portswigger&logoColor=white"/> <img src="https://img.shields.io/badge/Wireshark-1679A7?style=flat-square&logo=wireshark&logoColor=white"/> <img src="https://img.shields.io/badge/Checkov-5849BE?style=flat-square&logo=bridgecrew&logoColor=white"/> <img src="https://img.shields.io/badge/Trivy-1904DA?style=flat-square&logo=aquasecurity&logoColor=white"/> <img src="https://img.shields.io/badge/Gitleaks-181717?style=flat-square&logo=git&logoColor=white"/> <img src="https://img.shields.io/badge/MAVLink-00BCD4?style=flat-square&logo=drone&logoColor=white"/>

**Database & Monitoring**  
<img src="https://skillicons.dev/icons?i=mysql" /> <img src="https://img.shields.io/badge/CloudWatch-FF4F8B?style=flat-square&logo=amazoncloudwatch&logoColor=white"/> <img src="https://img.shields.io/badge/AWS_WAF-FF9900?style=flat-square&logo=amazonaws&logoColor=white"/>
...
> 대규모 서버 환경에서 KISA 주요정보통신기반시설 기준에 따라  
> **취약점 점검 → 자동 조치 → 보고서 생성**까지 전 과정을 자동화한 엔터프라이즈 보안 플랫폼
...
> GitHub Actions CI/CD, AWS 보안 관제, Checkov IaC 정책 자동화를  
> 하나의 저장소에서 통합 운영하는 **DevSecOps Control Plane**
...
> ArduPilot 기반 드론의 MAVLink2 미서명 통신 취약점을 분석하고,  
