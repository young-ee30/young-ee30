...
안녕하세요.  
보안 자동화, DevSecOps, 취약점 분석에 관심을 두고 **안전한 시스템을 직접 구현하는 보안 엔지니어**가 되고 싶은 **이가영**입니다.

취약점을 분석하는 공격 관점과, 안전한 인프라와 서비스를 설계하는 방어 관점을 함께 학습하며  
문제 발견에 그치지 않고 **자동화된 대응과 운영으로 연결하는 프로젝트**를 지향하고 있습니다.
...
### 🛡️ [KISA 기반 취약점 진단 자동화](https://github.com/young-ee30/security-vulnerability-diagnosis-automation)
