...
Security Engineer & Developer building **automated security solutions** — from vulnerability detection to remediation.

Passionate about bridging the gap between **offensive security research** and **practical defense engineering**, with hands-on experience in enterprise security automation, DevSecOps pipelines, and drone system exploitation.

- 🛡️ Building **enterprise security automation** platforms (KISA compliance, Ansible-driven)
- ☁️ Designing **DevSecOps pipelines** with AWS, Terraform, GitHub Actions & Checkov
- 🚁 Researching **drone security** — MAVLink protocol exploitation & firmware reversing
- 🔓 Reverse engineering with **IDA Pro** & **Ghidra**
- 📊 Automating **vulnerability scanning, remediation & reporting** at scale
...
Enterprise-grade security automation platform — **KISA compliance** vulnerability scanning, auto-remediation & report generation across large-scale server environments
...
**DevSecOps Control Plane** — GitHub Actions CI/CD, AWS security monitoring, Checkov IaC policy automation, Terraform infrastructure
...
Drone control hijacking research — **MAVLink2 unsigned communication** vulnerability analysis & signing key injection to take over ArduPilot drones
...
<div align="center">
<img src="https://github-readme-stats.vercel.app/api?username=young-ee30&show_icons=true&theme=tokyonight&hide_border=true&bg_color=0D1117&title_color=3B82F6&icon_color=3B82F6&text_color=FFFFFF" height="165"/>
<img src="https://github-readme-stats.vercel.app/api/top-langs/?username=young-ee30&layout=compact&theme=tokyonight&hide_border=true&bg_color=0D1117&title_color=3B82F6&text_color=FFFFFF" height="165"/>
</div>
